    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/**", "/school/**", "/schools/**", "/academic-year/**", "/student/**", "/staff/**", "/class/**", "/section/**", "/subject/**", "/department/**", "/student-class-section/**", "/routine/**", "/fee-category/**", "/fee-plan/**", "/fee-allocation/**", "/fee/**", "/fee-payment/**").permitAll()
