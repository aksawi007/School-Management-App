package org.sma.staff.mngt.app;
...
@ComponentScan(basePackages = {"org.sma.staff", "org.sma.platform.core", "org.sma.security.auth"})
public class StaffManagementApp {

    public static void main(String[] args) {
        SpringApplication.run(StaffManagementApp.class, args);
    }
}
